...
(function( $, undefined ) {
  ...
  $.widget( "ui.addresspicker", {
    options: {
        ...
        mapOptions: {
            zoom: 10,
            center: new google.maps.LatLng(39.945542, 32.857146),
            scrollwheel: true,
            ...
            if (status == google.maps.GeocoderStatus.OK) {
                for (var i = 0; i < results.length; i++) {
                    ...
                    {   
                        ...
                        if ((results[i].address_components[j].types[0] =="country") && (results[i].address_components[j].short_name =="TR"))
                        {
