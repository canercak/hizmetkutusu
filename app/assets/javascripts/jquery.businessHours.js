...
(function($) {
    $.fn.businessHours = function(opts) {
        var defaults = {
            ...
            weekdays: [I18n.t('date.abbr_day_names')[1], I18n.t('date.abbr_day_names')[2], I18n.t('date.abbr_day_names')[3], I18n.t('date.abbr_day_names')[4], I18n.t('date.abbr_day_names')[5], I18n.t('date.abbr_day_names')[6], I18n.t('date.abbr_day_names')[0]],
            operationTime: [
                {},
                {},
                {},
            ...
            dayTmpl: '<div class="dayContainer">' +
                ...
                '<div class="operationTime"><input type="text" name="startTime" id="wk_startTime" class="mini-time operationTimeFrom" value=""/></div>' +
                '<div class="operationTime"><input type="text" name="endTime" id="wk_endTime" class="mini-time operationTimeTill" value=""/></div>' +
                '</div></div>'
        };
                    ...
                    serialize: function() {
                        ...
                        container.find(".operationState").each(function(num, item) {
                            ...
                            data.push({
                                ...
                                timeFrom: isWorkingDay ? dayContainer.find("[name='startTime']").val() : "09:00",
                                timeTill: isWorkingDay ? dayContainer.find("[name='endTime']").val() : "18:00"
                            });
                        });
